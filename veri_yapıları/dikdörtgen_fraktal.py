...
def dikdortgen(points,level,win):    
    colormap = ['violet','red','green','white'] #,'yellow','violet','orange']
    ...
    if level > 0:
        ...
        dikdortgen([  getMid(points[0],points[1]),
                points[1],
                getMid(points[1],points[2]),
                getMid(points[1],points[3])],level-1,win)
        dikdortgen([  getMid(points[0],points[2]),                
                getMid(points[1],points[2]),
                points[2],
                getMid(points[2],points[3])],level-1,win)
        dikdortgen([  getMid(points[0],points[3]),                
